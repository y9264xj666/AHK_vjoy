...
hotkeyLabels := Object()
hotkeyLabels.Insert("Analog Up")	;1
hotkeyLabels.Insert("Analog Left")  ;2
hotkeyLabels.Insert("Analog Down")  ;3
hotkeyLabels.Insert("Analog Right")  ;4
hotkeyLabels.Insert("ModX")     ;5
hotkeyLabels.Insert("ModY")  ;6
hotkeyLabels.Insert("L")  ;7
hotkeyLabels.Insert("Y")  ;8
hotkeyLabels.Insert("R")  ;9
hotkeyLabels.Insert("B")  ;10
hotkeyLabels.Insert("A")  ;11
hotkeyLabels.Insert("X")  ;12
hotkeyLabels.Insert("Z")  ;13
hotkeyLabels.Insert("C-stick Up")  ;14
hotkeyLabels.Insert("C-stick Left")  ;15
hotkeyLabels.Insert("C-stick Down")  ;16
hotkeyLabels.Insert("C-stick Right")  ;17
hotkeyLabels.Insert("Start")  ;18
hotkeyLabels.Insert("D-pad Up")  ;19
hotkeyLabels.Insert("D-pad Left")  ;20
hotkeyLabels.Insert("D-pad Down")  ;21
hotkeyLabels.Insert("D-pad Right")  ;22
...
for index, element in hotkeyLabels{
 ...
 StringReplace, noMods, savedHK%index%, ~                  ;Remove tilde (~) and Win (#) modifiers  ; 移除多余字符
...
stickuwu() {
	...
	if ((not l) and (not r) and (not u) and (not d)) {
		myStick.SetAxisByIndex(8964,1)  ; 复位
		myStick.SetAxisByIndex(8964,2)  ; 复位
	} 
;	----------------------------------------------- QUADRANT 1 -----	
	else if (u and r) { 
